...
#
# Structure table for `creaquiz_categories` 6
#
...
#
# Structure table for `creaquiz_quiz` 20
#

CREATE TABLE `creaquiz_quiz` (
...
#
# Structure table for `creaquiz_questions` 9
#

CREATE TABLE `creaquiz_questions` (
  ...
  `quest_options` varchar(255) NOT NULL,
...
#
# Structure table for `creaquiz_answers` 5
#

CREATE TABLE `creaquiz_answers` (
...
#
# Structure table for `creaquiz_type_question` 4
#

CREATE TABLE `creaquiz_type_question` (
...
#
# Structure table for `creaquiz_messages` 3
#

CREATE TABLE `creaquiz_messages` (
...
#
# Structure table for `creaquiz_results` 9
#

CREATE TABLE `creaquiz_results` (
...
INSERT INTO creaquiz_categories( `cat_name`, `cat_description`,  `cat_theme`, `cat_weight`) VALUES 
