 ...
 * @return bool
 */
function creaquizCommentsUpdate($itemId, $itemNumb)
{
 ...
 * @return bool
 */
function creaquizCommentsApprove(&$comment)
{
	// Notification event
	// Get instance of module
	$creaquizHelper = \XoopsModules\Creaquiz\Helper::getInstance();
	...
	$tags['ITEM_URL']  = XOOPS_URL . '/modules/creaquiz/messages.php?op=show&msg_id=' . $msgId;
