 ...
 * @return bool|null
 */
 function xoops_module_update_creaquiz(\XoopsModule $xoopsModule, $previousVersion = null)
{
 ...
 * @return bool
 */
function creaquiz_check_db($module)
{
    $ret = true;
    ...
    $table   = $GLOBALS['xoopsDB']->prefix('creaquiz_images');
    $field   = 'img_exif';
