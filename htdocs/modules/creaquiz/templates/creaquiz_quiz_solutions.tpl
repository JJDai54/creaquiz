...
<{if $result}>
    ...
    <div class="item-round-top  <{$themeResult}>-item-head"><center><b><{$smarty.const._MA_CREAQUIZ_RESULTS_FOR}><{$result.result_uname}></b></center></div>
    <div class="item-round-none <{$themeResult}>-item-body" style="padding:20px 50px 20px 50px;">
    

      <table class='quizTbl'>
        <tr>
            <td><{$smarty.const._MA_CREAQUIZ_UNAME}></td>
            <td><{$result.result_uname}></td>
        </tr>
        <tr>
            <td><{$smarty.const._MA_CREAQUIZ_RESULTS_SCORE}></td>
            <td><{$result.score_achieved}> <{$smarty.const._MA_CREAQUIZ_ANSWERS_POINTS}> / <{$result.score_max}> <{$smarty.const._MA_CREAQUIZ_OF_TOTAL}></td>
        </tr>
        <tr>
            <td><{$smarty.const._MA_CREAQUIZ_ANSWERS_AT}></td>
            <td><{$result.answers_achieved}> <{$smarty.const._MA_CREAQUIZ_QUESTIONS}> / <{$result.answers_total}> <{$smarty.const._MA_CREAQUIZ_OF_TOTAL}></td>
        </tr>
        <tr>
            <td><{$smarty.const._MA_CREAQUIZ_RESULTS_DURATION}></td>
            <td><{$result.duration2}></td>
        </tr>
        <tr>
            <td><{$smarty.const._MA_CREAQUIZ_RESULTS_NOTE}></td>
            <td><{$result.note}> / 100</td>
        </tr>
      </table>
    </div>
    <div class="item-round-bottom <{$themeResult}>-item-legend"><center><b><{$smarty.const._MA_CREAQUIZ_THANKS_FOR_PARTICIPATION}></b></center></div><br>
...
<{/if}>
    ...
    <div class="item-round-top <{$quiz.theme_ok}>-item-head"><center><b><{$quiz.name}></b><br><{$smarty.const._MA_CREAQUIZ_QUIZ_ANSWERS_AND_EXPLANATION}></center></div>
    ...
    <div class="item-round-top <{$quiz.theme_ok}>-item-head"><center><{$smarty.const._CO_CREAQUIZ_SOMMAIRE}></center></div>
    ...
    <div class="item-round-none <{$quiz.theme_ok}>-item-body" style="padding:0px 30px 0px 30px;">
      ...
      <table class='quizTbl'>
        <{foreach item=question from=$questions name=quest}>
            <{if $question.typeForm == $smarty.const.CREAQUIZ_TYPE_FORM_QUESTION}>        
              <tr>
                  ...
                  <td>
                    <a href='#slide-<{$question.id}>' onclick='qm_scrollWin();'> 
                        <img src='<{$modPathArrows}>/goto.png' title='<{$smarty.const._CO_CREAQUIZ_SEE_ANSWER}>'>                         
                    </a>
                  </td>
              </tr>
              <tr><td colspan="3"><hr class='default-hr-style-one'></td></tr>    
                        
            <{elseif $question.typeForm == $smarty.const.CREAQUIZ_TYPE_FORM_BEGIN}>        
            <{elseif $question.typeForm == $smarty.const.CREAQUIZ_TYPE_FORM_END}>        
            <{elseif $question.typeForm == $smarty.const.CREAQUIZ_TYPE_FORM_GROUP}>        
              <tr>
    ...
    <{foreach item=question from=$questions name=quest}>
        ...
        <{if $question.typeForm == $smarty.const.CREAQUIZ_TYPE_FORM_QUESTION}>        
          <div class="item-round-none <{$quiz.theme_ok}>-item-info" style="padding:0px 50px 0px 50px;">
              ...
              <a href='#slide-sommaire' class='sommaire' onclick='qm_scrollWin(-80);'><img src='<{$modPathArrows}>/sommaire.png' title='<{$smarty.const._CO_CREAQUIZ_SOMMAIRE}>'></a></b>
          ...
          <{if $question.learn_more OR $question.see_also}>
              ...
              <{if $question.learn_more}>
                  <a href="<{$question.learn_more}>"  target="_blank"><{$smarty.const._MA_CREAQUIZ_LEARN_MORE}></a>
              <{/if}>
              <{if $question.see_also}>
                  <{if $question.learn_more}><br><{/if}>
                  <a href="<{$question.see_also}>" target="_blank"><{$smarty.const._MA_CREAQUIZ_SEE_ALSO}></a>
              <{/if}>
              </div>
          <{/if}>
