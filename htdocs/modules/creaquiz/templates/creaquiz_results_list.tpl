...
<form name='creaquiz_select_filter' id='creaquiz_select_filter' action='results.php' method='post' onsubmit='return xoopsFormValidate_form();' enctype=''>
...
<{if $resultsCount > 0}>
	...
	<table id='quiz_question_list' name='quiz_question_list' class='table table-bordered' style='margin-bottom=0px;'>
		<thead>
			<tr class='head'>
				<th class="center">#</th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_UNAME}></th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_SCORE}></th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_ANSWERS}></th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_DURATION}></th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_NOTE}></th>
				<th class="center"></th>
				<th class="center"><{$smarty.const._MA_CREAQUIZ_DATE}></th>
			</tr>
		</thead>
		<{if $results_count}>
		<tbody>
...
.quiz_legend3{
    ...
    <div class="item-round-top <{$catTheme}>-item-head"><center><{$smarty.const._CO_CREAQUIZ_LEGEND}></center></div>
    <div class="item-round-none <{$catTheme}>-item-body">
    <center>
<table class='quizTbl'>
    <tr>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/005.png"></td>
        <td class='quiz_legend'><{$smarty.const._MA_CREAQUIZ_RESULT_5}></td>
        <td class='quiz_legend3'></td>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/002.png"></td>
        <td class='quiz_legend'><{$smarty.const._MA_CREAQUIZ_RESULT_2}></td>
    </tr>
    <tr>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/004.png"></td>
        <td class='quiz_legend'><{$smarty.const._MA_CREAQUIZ_RESULT_4}></td>
        <td class='quiz_legend3'></td>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/001.png"></td>
        <td class='quiz_legend left'><{$smarty.const._MA_CREAQUIZ_RESULT_1}></td>
    </tr>
    <tr>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/003.png"></td>
        <td class='quiz_legend'><{$smarty.const._MA_CREAQUIZ_RESULT_3}></td>
        <td class='quiz_legend3'></td>
        <td class='quiz_legend3'><img src="<{$modPathIcon16}>/notes/000.png"></td>
        <td class='quiz_legend left'><{$smarty.const._MA_CREAQUIZ_RESULT_0}></td>
    </tr>
...
<{else}>
    ...
    <div class="item-round-top <{$catTheme}>-item-head"><center><{$smarty.const._MA_CREAQUIZ_RESULTS}></center></div>
    <div class="item-round-none <{$catTheme}>-item-body">
        <center><{$smarty.const._MA_CREAQUIZ_NO_RESULTS}></center> 
    </div>
    <div class="item-round-bottom <{$catTheme}>-item-legend" style='margin-top:0px;'><center>...</center></div><br>
