...
<center>
<h1>Quiz en javascript pour le module "creaquiz" pour Xoops</h1>
...
<script src="data/quiz-questions-01.js"></script>
<script src="data/quiz-options.js"></script>
<script src="js/quiz-fr.js"></script>
