...
<form name='creaquiz_select_filter' id='creaquiz_select_filter' action='type_question.php' method='post' onsubmit='return xoopsFormValidate_form();' enctype=''>
...
<{$smarty.const._AM_CREAQUIZ_TYPE_QUESTION_CATEGORY}> : <{$inpCatTQ}>
...
//alert("addNewQuestion : " + typeQuestion);
    document.creaquiz_select_filter.quest_type_question.value = typeQuestion;
	...
	<table id='quiz_type_question_list' name='quiz_type_question_list' class='table table-bordered'>
		<thead>
			<tr class='head'>
				...
				<th class="center"><{$smarty.const._AM_CREAQUIZ_TYPE}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_NAME}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_SHORTDESC}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_WEIGHT}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_ACTIONS}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_IMAGE}></th>
				...
				<td class='center'>
                    <{if $TypeDeQuestion.canDelete}>
                      <a  onclick="addNewQuestion('<{$TypeDeQuestion.type}>');">
          				<img src="<{xoModuleIcons32}>add.png" alt="Add Question" title='<{$smarty.const._AM_CREAQUIZ_ADD_NEW_QUESTION}>' />
                      </a>
                    <{/if}>
                <td class='left'>
