...
<{if $messages_list}>
<form name='creaquiz_select_filter' id='creaquiz_select_filter' action='messages.php?op=list' method='post' onsubmit='return xoopsFormValidate_form();' enctype=''>
    <input type="hidden" name="op" value="list" />
    <{$smarty.const._AM_CREAQUIZ_LANGUAGE}> : <{$inpLanguage}>
</form>

	<table class='table table-bordered'>
		<thead>
			<tr class='head'>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_MESSAGES_ID}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_MESSAGES_CODE}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_MESSAGES_LANGUAGE}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_MESSAGES_MESSAGE}></th>
