...
<{if $categories_list}>
	<table class='table table-bordered'>
		<thead>
			<tr class='head'>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_CATEGORIES_ID}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_CATEGORIES_NAME}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_WEIGHT}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_CATEGORIES_THEME}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_CREATION}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_UPDATE}></th>
				<th class="center"><{$smarty.const._AM_CREAQUIZ_NB_QUIZ}></th>
		...
		<tbody>
			...
			<tr class='<{cycle values='odd, even'}>'>
				...
				<td class="center  width5">
                    ...
                    <{else}>
                        <img src="<{xoModuleIcons16 warning.png}>" alt="categories" title="<{$smarty.const._AM_CREAQUIZ_CAT_NOT_EMPTY}>"/>
                    <{/if}>
					<img src="<{$modPathIcon16}>/blank-16.png" alt="" />
					<a href="quiz.php?op=list&cat_id=<{$cat.id}>&sender='cat_id'" title="<{$smarty.const._AM_CREAQUIZ_QUIZ}>">
