...
$templateMain = 'creaquiz_admin_about.tpl';
...
function contribution(){
    ...
    $html[] = "<div>" . _AM_CREAQUIZ_WHY_DONATE . "</div><center>";
...
$module_dir = basename(dirname(dirname(__FILE__)));
    ...
    $license_url = $creaquizHelper->getModule()->getInfo('license_url');
    ...
    $html[] = "<img src=\"" . XOOPS_URL . '/modules/' . $module_dir . '/' . $creaquizHelper->getModule()->getInfo('image') . "\" alt=\"" . $module_dir . "\" style=\"float: left; margin-right: 10px;\">";
    $html[] = "</td><td>";
    $html[] = "<div style=\"margin-top: 1px; margin-itemRound-bottom: 4px; font-size: 18px; line-height: 18px; color: #2F5376; font-weight: bold;\">";
    $html[] = $creaquizHelper->getModule()->getInfo('name');
    $html[] = " - ";
    $html[] = $creaquizHelper->getModule()->getInfo('version');
    $html[] = " - ";
    $html[] = $creaquizHelper->getModule()->getInfo('module_status');
    $html[] = "</div>";
    
    
    $html[] = "<div style=\"line-height: 16px; font-weight: bold;\">";
    $html[] = _AM_CREAQUIZ_BY . " ".  $creaquizHelper->getModule()->getInfo('author');
    $html[] = "</div>";
    $html[] = "<div style=\"line-height: 16px;\">";
    $html[] = "<a href=\"$license_url\" target=\"_blank\" rel=\"external\">" . $creaquizHelper->getModule()->getInfo('license') . "</a>";
    $html[] = "<br>";
    $html[] = "<a href=\"" . $creaquizHelper->getModule()->getInfo('author_website_url') . "\" target=\"_blank\">" . $creaquizHelper->getModule()->getInfo('author_website_name') . "</a>";
    $html[] = "</div>";
...
$module_dir = basename(dirname(dirname(__FILE__)));
$module = $creaquizHelper->getModule();
...
/* ------------------------- Module -----------------------------*/
$box['paypal']['legend'] = _AM_CREAQUIZ_CONTRIBUTION;
