...
switch ($op) {
    case 'load':
        if (\Xmf\Request::hasVar('ok', 'REQUEST') && 1 == $_REQUEST['ok']) {
            ...
            xoops_cp_header();
            xoops_confirm(['ok' => 1, 'op' => 'load'], 'index.php', sprintf(constant('_CO_CREAQUIZ_ADD_SAMPLEDATA_OK')), constant('_CO_CREAQUIZ_CONFIRM'), true);
            xoops_cp_footer();
        }
        break;
    case 'save':
...
function loadSampleData()
{
    ...
    redirect_header('../admin/index.php', 1, constant('_CO_CREAQUIZ_SAMPLEDATA_SUCCESS'));
}
...
function exportSchema()
{
    ...
    try {
        ...
        //        $migrate = new Creaquiz\Migrate($moduleDirName);
        //        $migrate->saveCurrentSchema();
        //
        //        redirect_header('../admin/index.php', 1, constant('_CO_CREAQUIZ_EXPORT_SCHEMA_SUCCESS'));
    }
    catch (\Exception $e) {
        exit(constant('_CO_CREAQUIZ_EXPORT_SCHEMA_ERROR'));
    }
