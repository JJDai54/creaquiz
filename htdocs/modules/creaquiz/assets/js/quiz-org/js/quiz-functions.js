...
//    alert("getTplNewClass : " + currentQuestion.type);
    ...
    //case "checkboxLogical2":    obj = new (checkboxLogical2)(currentQuestion, chrono);  break;
    ...
    case "imagesLogical":       obj = new (imagesLogical)(currentQuestion, chrono);     break;
    case "imagesSimple":        obj = new (imagesSimple)(currentQuestion, chrono);      break;
    
    case "imagesDaDLogical":    obj = new (imagesDaDLogical)(currentQuestion, chrono);  break;
    case "imagesDaDMatchItems": obj = new (imagesDaDMatchItems)(currentQuestion, chrono); break;
    case "imagesDaDBasket":     obj = new (imagesDaDBasket)(currentQuestion, chrono);     break;
    case "imagesDaDGroups":     obj = new (imagesDaDGroups)(currentQuestion, chrono);     break;
    case "imagesDaDSortItems":  obj = new (imagesDaDSortItems)(currentQuestion, chrono);   break;
    
    case "ulSortList":          obj = new (ulSortList)(currentQuestion, chrono);   break;
