...
class Utility
{
     ...
     */
    public static function getEditor($creaquizHelper = null, $options = null)
    {
...
//         $tPerms['cat'] = $gpermHandler->getItemIds('creaquiz_view_categories', $groups, $moduleHandler->getVar('mid'));
//         $tPerms['quiz'] = $gpermHandler->getItemIds('creaquiz_view_quiz', $groups, $moduleHandler->getVar('mid'));
// 
//         return $tPerms;
//     }
