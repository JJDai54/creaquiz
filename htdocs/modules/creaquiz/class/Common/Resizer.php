        ...
        if (4 == $this->mergeType) {
            ...
            switch ($this->mergePos) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    imagecopy($dest, $src, 0, $posRow2, 0, 0, $imgWidth, $imgHeight); //itemRound-bottom left
                    break;
                case 4:
                    imagecopy($dest, $src, $posCol2, $posRow2, 0, 0, $imgWidth, $imgHeight); //itemRound-bottom right
                    break;
            }
        }
        if (6 == $this->mergeType) {
            ...
            switch ($this->mergePos) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    imagecopy($dest, $src, $posCol2, $posRow2, 0, 0, $imgWidth, $imgHeight); //itemRound-bottom center
                    break;
                case 6:
                    imagecopy($dest, $src, $posCol3, $posRow2, 0, 0, $imgWidth, $imgHeight); //itemRound-bottom right
                    break;
            }
        }
