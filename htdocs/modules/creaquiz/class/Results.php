...
class Results extends \XoopsObject
{
	...
	public function getFormResults($action = false)
	{
		...
		// Title
		$title = $this->isNew() ? sprintf(_AM_CREAQUIZ_RESULTS_ADD) : sprintf(_AM_CREAQUIZ_RESULTS_EDIT);
		// Get Theme Form
	...
	public function getValuesResults($keys = null, $format = null, $maxDepth = null)
	{
		...
		$ret['duration2']        = $this->format_duration($this->getVar('result_duration'),_MA_CREAQUIZ_HOUR,_MA_CREAQUIZ_MINUTES,_MA_CREAQUIZ_SECONDS, ' ');     
