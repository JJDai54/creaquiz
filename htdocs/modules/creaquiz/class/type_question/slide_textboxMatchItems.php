 ...
 */
class slide_textboxMatchItems extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("textboxMatchItems", 0, 420, "textbox");
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $labComparaison = new xoopsFormLabel('', _AM_CREAQUIZ_COMPARAISON);
      $trayOptions->addElement($labComparaison);     
      
      $name = 'comparaison';  
      $inputComparaison = new XoopsFormRadio('', "{$optionName}[{$name}]", $tValues[$name], '<br>');
      $inputComparaison->addOption("0", _AM_CREAQUIZ_COMPARAISON_0);            
      $inputComparaison->addOption("1", _AM_CREAQUIZ_COMPARAISON_1);            
      $inputComparaison->addOption("2", _AM_CREAQUIZ_COMPARAISON_2);            
...
// echo "<hr>answers<pre>" . print_r($answers, true) . "</pre><hr>";
        ...
        for($h = 0; $h < $this->maxPropositions; $h++){
            ...
            $inpMot2 = new XoopsFormText(_AM_CREAQUIZ_SLIDE_MOT . " 2", $name, $this->lgMot3, $this->lgMot4, $mot2);
