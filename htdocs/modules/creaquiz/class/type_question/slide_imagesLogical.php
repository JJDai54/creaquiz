 ...
 */
class slide_imagesLogical extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("imagesLogical", 0, 100, "images");
        $this->maxPropositions = 8;	
        $this->optionsDefaults = ['imgHeight1'=>64,'imgHeight2'=>48, 'minReponses'=>0];
    }
...
//         $inpImgSubstitut= new \XoopsFormSelect(_AM_CREAQUIZ_IMG_SUBSTITUT, $this->getName($i,'image'),$imgName);   
