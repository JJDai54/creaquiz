 ...
 */
class slide_textareaInput extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("textareaInput", 0, 620, "textarea");
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $name = 'orientation';  
      $inputOrientation = new \XoopsFormRadio(_AM_CREAQUIZ_ORIENTATION, "{$optionName}[{$name}]", $tValues[$name], ' ');
...
//       $inpTitle = new \XoopsFormText(_AM_CREAQUIZ_SLIDE_CAPTION0, "{$optionName}[{$name}]", $this->lgProposition, $this->lgProposition, $tValues[$name]);
      ...
      $name = 'scoreByWord';  
      $inpScore = new \XoopsFormNumber(_AM_CREAQUIZ_SLIDE_001,  "{$optionName}[{$name}]",$this->lgPoints,  $this->lgPoints, $tValues[$name]);
...
* ************************************************** */
 	public function getForm($questId, $quizId)
 	{
        ...
        //-------------------------------------------------
        $trayAns = new XoopsFormElementTray  (_AM_CREAQUIZ_TEXTE, $delimeter = '<br>'); //, $name = '');
...
/*
        $inpPoints = new XoopsFormText(_AM_CREAQUIZ_SLIDE_001, $this->getName('points'), $this->lgPoints, $this->lgPoints, $points); 
