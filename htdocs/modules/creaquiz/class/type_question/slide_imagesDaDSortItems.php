 ...
 */
class slide_imagesDaDSortItems extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("imagesDaDSortItems", 0, 100, "imagesDaD");
        $this->maxPropositions = 8;	
        $this->optionsDefaults = ['height1'=>64, 'moveMode'=>0, 'showCaptions'=>'B'];
    }
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $trayHeight1 = new XoopsFormElementTray(_AM_CREAQUIZ_IMG_HEIGHT, $delimeter = ' ');  
      ...
      $name = 'moveMode';  
      $inpMoveMode = new \xoopsFormRadio(_AM_CREAQUIZ_MOVE_MODE, "{$optionName}[{$name}]" ,$tValues[$name] , ' ');
      $inpMoveMode->addOptionArray(['0'=>_AM_CREAQUIZ_IMG_FLIP, "1"=>_AM_CREAQUIZ_IMG_INSERT]);
...
//echo "getForm : count = " . count($answers) . " | " . count($substitutImg) . " | " . count($sequence) . " | " . count($badly) . '<br>';
        ...
        $i = $this->getFormGroup($trayAllAns, $answers, _AM_CREAQUIZ_SEQUENCE, 0, $this->maxPropositions, $path);
