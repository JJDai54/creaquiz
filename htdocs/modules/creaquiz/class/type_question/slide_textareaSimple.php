 ...
 */
class slide_textareaSimple extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("textareaSimple", 0, 600, "textarea");
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $name = 'strToReplace';
      $inputStrToReplace = new XoopsFormText(_AM_CREAQUIZ_CARS_TO_REPLACE,"{$optionName}[{$name}]", $this->lgMot1, $this->lgMot1, $tValues[$name]);            
...
//    echo "<hr>answers<pre>" . print_r($answers, true) . "</pre><hr>";
        ...
        for($i = 0; $i < $this->maxPropositions ; $i++){
            ...
            $inpCaption = new XoopsFormText(_AM_CREAQUIZ_SLIDE_TITLE, $name, $this->lgProposition, $this->lgProposition, $caption);
            ...
            $inpPropo = $this->getformTextarea(_AM_CREAQUIZ_QUESTIONS_TEXT_TO_CORRECT, $this->getName($i, 'proposition'), $proposition);
