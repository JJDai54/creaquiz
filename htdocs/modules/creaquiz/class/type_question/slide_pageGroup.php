...
include_once CREAQUIZ_PATH . "/class/type_question/slide_pageBegin.php";
 ...
 */
class slide_pageGroup extends XoopsModules\Creaquiz\Type_question //slide_pageBegin
{
	...
	{
        parent::__construct("pageGroup", 0, 10, "page");
...
//    echo "<hr>answers<pre>" . print_r($answers, true) . "</pre><hr>";
        ...
        for($i = 0; $i < $this->maxPropositions ; $i++){
            ...
            //$inpPropo = $this->getformTextarea(_AM_CREAQUIZ_SLIDE_TEXTES, $name, $proposition);        
            //$inpPropo = $this->getformAdmin(_AM_CREAQUIZ_SLIDE_TEXTES, $name, $proposition);      
            $inpPropo  = $quizUtility->getEditor2(_AM_CREAQUIZ_SLIDE_TEXTES, $name, $proposition,  null , null, null);
