 ...
 */
class slide_imagesDaDLogical extends XoopsModules\Creaquiz\Type_question
{
	...
	{
        parent::__construct("imagesDaDLogical", 0, 100, "imagesDaD");
...
* *********************************************************** */
 	public function getFormOptions($caption, $optionName, $jsonValues = null)
 	{
      ...
      $trayHeight1 = new \XoopsFormElementTray(_AM_CREAQUIZ_SEQUENCE0, $delimeter = ' ');  
...
$i = $this->getFormGroup($trayAllAns, 0, $answers, _AM_CREAQUIZ_SEQUENCE, 0, $this->maxPropositions, $path);
...
//define('', "");            
            ...
            if($addNew){
              ...
              //$delSubstitut->addOption(1, _AM_CREAQUIZ_DELETE);
            }
...
//         $inpImgSubstitut= new \XoopsFormSelect(_AM_CREAQUIZ_IMG_SUBSTITUT, $this->getName($i,'image'),$image);   
//         $inpImgSubstitut->addOptionArray($listImg);
//$inpImgSubstitut = $this->getFormSelectImage(_AM_CREAQUIZ_IMG_SUBSTITUT, $image, $this->getName($i,'image'), $imgUrl, $imgList, $maxWidth=80);    
