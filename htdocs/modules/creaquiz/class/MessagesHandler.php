...
class MessagesHandler extends \XoopsPersistableObjectHandler
{
	...
	{
		parent::__construct($db, 'creaquiz_messages', Messages::class, 'msg_id', 'msg_code');
	}
 ...
 * *********************** */
    public function getLanguages(){
        ...
        $folder = CREAQUIZ_QUIZ_JS_ORG . "/js/language";
...
public function buildJsLanguage($language){
	...
	foreach(array_keys($rst) as $i) {
        ...
        //$value = constant('_JS_CREAQUIZ_' . $rst[$i]->getVar('msg_constant')) ;
    ...
    $fileName = CREAQUIZ_QUIZ_JS_ORG . "/js/language/quiz-{$language}.js";
