...
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ADMENU1,
	'link' => 'admin/index.php',
	'icon' => $sysPathIcon32.'/dashboard.png',
];
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ADMENU2,
	'link' => 'admin/categories.php',
	'icon' => 'assets/icons/32/block.png',
];
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ADMENU3,
	'link' => 'admin/quiz.php',
	'icon' => 'assets/icons/32/album.png',
];
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ADMENU4,
...
*/
$adminmenu[] = [
    'title' => _MI_CREAQUIZ_ADMENU_CLONE,
    'link' => 'admin/clone.php',
    'icon' => $sysPathIcon32.'/clone.png',
];

$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ADMENU10,
	'link' => 'admin/feedback.php',
	'icon' => $sysPathIcon32.'/mail_foward.png',
];
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_ABOUT,
	'link' => 'admin/about.php',
	'icon' => $sysPathIcon32.'/about.png',
];
$adminmenu[] = [
	'title' => _MI_CREAQUIZ_MINIFY,
