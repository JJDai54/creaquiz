...
define('_AM_CREAQUIZ_MINIFY',"Minification");
define('_SUBMIT_ALL',"submit_all");
define('_AM_CREAQUIZ_MINIFY_ALL',"Minifier tous les fichiers sauf lang");
define('_AM_CREAQUIZ_MINIFY_SELECTION',"Minifier la sélection");
define('_AM_CREAQUIZ_MINIFY_JS',"Minifier le JS");
define('_AM_CREAQUIZ_MINIFY_CSS',"Minifier les CSS");
define('_AM_CREAQUIZ_MINIFY_HTML',"Minifier les HTML");
define('_AM_CREAQUIZ_MINIFY_LANGUAGE',"Minifier les fichiers de langues");
define('_AM_CREAQUIZ_MINIFY_RESTAURE_ORG',"Restaure les originaux");
define('_AM_CREAQUIZ_MINIFY_RESTAURE_OK',"Restaure OK");
...
$templateMain = 'creaquiz_admin_minify.tpl';


////////////////////////////////////////////////////////////////////////
$pathSource = CREAQUIZ_QUIZ_JS_ORG;
$pathDest   = CREAQUIZ_QUIZ_JS_MIN;
...
switch($op) {
    case "minify_ok":
        ...
        case "retaure_org":
            ...
            //exit('retaure_org');
            redirect_header('minify.php',3,_AM_CREAQUIZ_MINIFY_RESTAURE_OK);
            break;
        default:
        case 'selection':
...
// 		}
		...
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[retaure_org]', _AM_CREAQUIZ_MINIFY_RESTAURE_ORG, 'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[all]', _AM_CREAQUIZ_MINIFY_ALL, 'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[selection]', _AM_CREAQUIZ_MINIFY_SELECTION, 'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[js]', _AM_CREAQUIZ_MINIFY_JS,    'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[css]', _AM_CREAQUIZ_MINIFY_CSS, 'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[html]', _AM_CREAQUIZ_MINIFY_HTML, 'submit'));
		$buttonsTray->addElement(new \XoopsFormButton('', 'submit[language]', _AM_CREAQUIZ_MINIFY_LANGUAGE,    'submit'));
