...
use XoopsModules\Creaquiz\Constants;
   ...
   echo "<hr>FILES<pre>" . print_r($_FILES, true) . "</pre><hr>";
...
//=============================================================================
          if ($addNew)
			redirect_header('questions.php?op=new&' . getParams2list($quizId, $quest_type_question, "", $quest_parent_id), 2, _AM_CREAQUIZ_FORM_OK);
          else if ($sender == 'type_question_list')
			redirect_header('type_question.php?op=list&' . getParams2list($quizId, $quest_type_question, $sender, $quest_parent_id), 2, _AM_CREAQUIZ_FORM_OK);
          else
			redirect_header('questions.php?op=list&' . getParams2list($quizId, $quest_type_question, "", $quest_parent_id), 2, _AM_CREAQUIZ_FORM_OK);
